                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" 
                               value="{{ old('code', $project->code) }}" placeholder="e.g., PROJ-001" required>
                        @error('code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="project_manager_id" class="form-select @error('project_manager_id') is-invalid @enderror" required>
                            ...
                            @foreach($projectManagers as $manager)
                                <option value="{{ $manager->id }}" {{ old('project_manager_id', $currentManager?->id) == $manager->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="store_manager_id" class="form-select @error('store_manager_id') is-invalid @enderror" required>
                            ...
                            @foreach($storeManagers as $manager)
                                <option value="{{ $manager->id }}" {{ old('store_manager_id', $currentStoreManager?->id) == $manager->id ? 'selected' : '' }}>
                                    {{ $manager->name }} ({{ $manager->email }})
                                </option>
                            @endforeach
                        </select>
