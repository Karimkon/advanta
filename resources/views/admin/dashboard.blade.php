    ...
    <div class="col-12">
      <div class="card border-0 shadow-sm border-start border-4 border-success">
        <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
          <h5 class="mb-0">
            <i class="bi bi-truck text-success me-2"></i>Company Equipments Worth
          </h5>
          <a href="{{ route('admin.equipments.index') }}" class="btn btn-sm btn-outline-success">Manage Equipments</a>
        </div>
        <div class="card-body">
