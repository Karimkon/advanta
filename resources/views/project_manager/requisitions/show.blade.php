        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('project_manager.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('project_manager.requisitions.index') }}">Requisitions</a></li>
                ...
                <div class="card-body">
                    @if($requisition->status === 'pending' && $requisition->requested_by !== auth()->id())
                        <div class="alert alert-warning">
                            <strong>Action Required:</strong> This requisition needs your approval.
                        </div>
                        
                        <form action="{{ route('project_manager.requisitions.approve', $requisition) }}" method="POST" class="d-grid mb-2">
                            @csrf
                            <div class="mb-2">
                        ...
                        <form action="{{ route('project_manager.requisitions.reject', $requisition) }}" method="POST" class="d-grid">
                            @csrf
                            <div class="mb-2">
                    ...
                    @if($requisition->lpo)
                        <div class="mt-3 p-3 bg-light rounded">
                            <h6>LPO Information</h6>
                            <p class="mb-1"><strong>LPO Number:</strong> {{ $requisition->lpo->lpo_number }}</p>
                            <p class="mb-1"><strong>Supplier:</strong> {{ $requisition->lpo->supplier->name ?? 'N/A' }}</p>
                            <p class="mb-0"><strong>Status:</strong> {{ ucfirst($requisition->lpo->status) }}</p>
                        </div>
                    @endif
                </div>
            </div>
