...
@section('title', 'QHSE Reports - Operations Dashboard')
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h2 class="fw-bold text-dark mb-1">{{ $stats['companydocuments'] }}</h2>
                            <small class="text-dark">Company documents</small>
                        </div>
                        <div class="icon-wrapper bg-light rounded-circle p-3">
                            <i class="bi bi-folder fs-4 text-dark"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form method="GET" class="row g-3">
                ...
                <div class="col-12">
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('operations.qhse-reports.index') }}" class="btn btn-outline-secondary">Clear Filters</a>
                    </div>
                </div>
            </form>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('operations.qhse-reports.show', $report) }}" 
