        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('operations.requisitions.index') }}">Requisitions</a></li>
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    @if($requisition->status === 'project_manager_approved')
                        ...
                        <form action="{{ route('operations.requisitions.approve', $requisition) }}" method="POST" class="d-grid mb-2">
                            @csrf
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                <label for="approved_amount" class="form-label">Approved Amount (Optional)</label>
                                <input type="number" name="approved_amount" id="approved_amount" 
                                       class="form-control" step="0.01" min="0"
                                       placeholder="Leave empty to use estimated total"
                        ...
                        <form action="{{ route('operations.requisitions.reject', $requisition) }}" method="POST" class="d-grid">
                            @csrf
                            <div class="mb-2">
