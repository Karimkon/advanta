        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('ceo.milestones.project', $project) }}">{{ $project->name }}</a></li>
                    <li class="breadcrumb-item active">{{ $milestone->title }}</li>
                </ol>
            </nav>
        </div>
        <div class="btn-group">
            <a href="{{ route('ceo.milestones.project', $project) }}" class="btn btn-outline-secondary">
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('ceo.milestones.index') }}" 
