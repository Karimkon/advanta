...
<head>
    <meta charset="UTF-8">
    <title>CEO Portal - Advanta ERP</title>
    ...
    <style>
        body {
            ...
            background: linear-gradient(135deg, #2a0f1f, #3b1e2b);
            color: #fff;
            min-height: 100vh;
            overflow: hidden;
            position: relative;
        ...
        .animated-orb {
            ...
            width: 250px;
            height: 250px;
            background: radial-gradient(circle, #d63384, #ec4899, #f472b6);
            border-radius: 50%;
            filter: blur(120px);
            opacity: .4;
            z-index: 0;
...
<div class="d-flex align-items-center justify-content-center vh-100 px-3">
    <div class="login-container">
        <div class="text-center mb-4">
            ...
            <h4 class="login-title">CEO Portal</h4>
            <p class="role-description">Executive dashboard and strategic oversight</p>
        </div>
        ...
        <form method="POST" action="{{ route('ceo.login.submit') }}">
            ...
            <div class="d-grid">
                <button class="btn btn-ceo text-white fw-bold">
                    <i class="bi bi-graph-up me-1"></i> Access CEO Portal
                </button>
            </div>
        </form>
