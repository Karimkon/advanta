        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1">
                    <li class="breadcrumb-item"><a href="{{ route('ceo.equipments.index') }}">Equipments</a></li>
                    <li class="breadcrumb-item active">{{ $equipment->name }}</li>
                </ol>
            </nav>
            <h2 class="fw-bold mb-0">{{ $equipment->name }}</h2>
        </div>
        <a href="{{ route('ceo.equipments.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm bg-success text-white">
                <div class="card-body text-center">
                    <p class="mb-1 small opacity-75">Equipment Value</p>
                    <h2 class="fw-bold mb-0">UGX {{ number_format($equipment->value, 0) }}</h2>
                </div>
            </div>
