            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('ceo.requisitions.show', $requisition) }}" class="btn btn-outline-secondary btn-sm">
                            <i class="bi bi-arrow-left"></i> Back to Requisition
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('ceo.requisitions.update', $requisition) }}" method="POST" id="requisitionForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('ceo.requisitions.show', $requisition) }}" class="btn btn-outline-secondary">Cancel</a>
