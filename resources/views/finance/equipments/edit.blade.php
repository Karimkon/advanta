...
@section('title', 'Edit ' . $equipment->name . ' - Finance')
...
<div class="container-fluid">
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1">
                    <li class="breadcrumb-item"><a href="{{ route('finance.equipments.index') }}">Equipments</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('finance.equipments.show', $equipment) }}">{{ $equipment->name }}</a></li>
                    <li class="breadcrumb-item active">Edit</li>
                </ol>
            </nav>
            <h2 class="fw-bold mb-0">✏️ Edit Equipment</h2>
        </div>
        <a href="{{ route('finance.equipments.show', $equipment) }}" class="btn btn-outline-secondary">
    ...
    <form action="{{ route('finance.equipments.update', $equipment) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm mt-4">
                    <div class="card-body">
                        ...
                        <a href="{{ route('finance.equipments.show', $equipment) }}" class="btn btn-outline-secondary w-100">
                            Cancel
                        </a>
                    </div>
                </div>
