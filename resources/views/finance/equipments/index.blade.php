...
@section('title', 'Company Equipments - Finance')
...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Manage and track all company equipment across projects</p>
        </div>
        <a href="{{ route('finance.equipments.create') }}" class="btn btn-success">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('finance.equipments.index') }}" class="row g-3">
                <div class="col-md-3">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('finance.equipments.show', $equipment) }}" class="btn btn-outline-primary" title="View">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('finance.equipments.edit', $equipment) }}" class="btn btn-outline-warning" title="Edit">
                                    ...
                                    <form id="delete-form-{{ $equipment->id }}" action="{{ route('finance.equipments.destroy', $equipment) }}" method="POST" class="d-none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
                            ...
                            <tr>
                                <td colspan="9" class="text-center py-5">
                                    <div class="text-muted">
                                        ...
                                        <a href="{{ route('finance.equipments.create') }}" class="btn btn-success mt-3">
