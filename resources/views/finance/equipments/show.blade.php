...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="btn-group">
            <a href="{{ route('finance.equipments.edit', $equipment) }}" class="btn btn-warning">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm mt-4">
                <div class="card-body">
                    <a href="{{ route('finance.equipments.edit', $equipment) }}" class="btn btn-warning w-100 mb-2">
                    ...
                    <form id="delete-form" action="{{ route('finance.equipments.destroy', $equipment) }}" method="POST" class="d-none">
                        @csrf
                        @method('DELETE')
                    </form>
                </div>
