            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('procurement.requisitions.show', $requisition) }}" class="btn btn-outline-secondary btn-sm">
                            <i class="bi bi-arrow-left"></i> Back to Requisition
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('procurement.requisitions.update', $requisition) }}" method="POST" id="requisitionForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $requisition->project->name }}" readonly>
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> Updating this requisition will also update the associated LPO ({{ $requisition->lpo->lpo_number }})
                        </div>
                        @endif

                        <!-- Submit Buttons -->
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('procurement.requisitions.show', $requisition) }}" class="btn btn-outline-secondary">Cancel</a>
