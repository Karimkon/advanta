...
class EquipmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('finance.equipments.index', compact(
            'equipments',
            'stats',
            'categories',
            'statuses',
    ...
    public function create()
    {
        ...
        return view('finance.equipments.create', compact(
            'categories',
            'statuses',
            'conditions',
            'projects'
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('finance.equipments.show', $equipment)
    ...
    public function show(Equipment $equipment)
    {
        ...
        return view('finance.equipments.show', compact('equipment'));
    }
    ...
    public function edit(Equipment $equipment)
    {
        ...
        return view('finance.equipments.edit', compact(
            'equipment',
            'categories',
            'statuses',
            'conditions',
    ...
    public function destroy(Equipment $equipment)
    {
        ...
        return redirect()
            ->route('finance.equipments.index')
