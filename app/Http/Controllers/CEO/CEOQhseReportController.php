...
class CEOQhseReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('ceo.qhse-reports.index', compact('reports', 'stats'));
    }

    public function show(QhseReport $qhseReport)
    {
        return view('ceo.qhse-reports.show', compact('qhseReport'));
    }
    ...
    public function destroy(QhseReport $qhseReport)
    {
        ...
        return redirect()->route('ceo.qhse-reports.index')
